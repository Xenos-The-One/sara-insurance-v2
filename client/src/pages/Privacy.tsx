/* =============================================================
   ...
   Canadian context: PIPEDA, Ontario, Toronto
   ============================================================= */
        ...
        <section className="py-16 bg-white">
          <div className="container mx-auto px-4 lg:px-8 max-w-3xl">
            <div className="prose prose-slate max-w-none text-sm leading-relaxed text-gray-700 space-y-6">
              ...
              <p>Sara Siblini, Licensed Life Insurance Representative with Primerica Life Insurance Company of Canada ("we," "us," or "our"), is committed to protecting your privacy in accordance with the <em>Personal Information Protection and Electronic Documents Act</em> (PIPEDA) and applicable Ontario privacy legislation. This Privacy Policy explains how we collect, use, disclose, and safeguard your personal information when you visit our website and use our services.</p>

              <h2 className="font-['Playfair_Display'] text-xl font-bold text-[#1a365d] mt-8">1. Information We Collect</h2>
              <p><strong>Personal Information:</strong> When you submit a quote request, book a consultation, or contact us, we may collect your name, email address, phone number, date of birth, and health information necessary to provide insurance quotes and facilitate coverage through Primerica Life Insurance Company of Canada.</p>
              ...
              <p>We use the information we collect to: provide and improve our services; respond to your inquiries and quote requests; schedule and conduct consultations; send you relevant information about insurance products (with your consent); comply with legal obligations under PIPEDA and applicable Canadian law; and analyze website usage to improve user experience.</p>

              <h2 className="font-['Playfair_Display'] text-xl font-bold text-[#1a365d] mt-8">3. Email Marketing</h2>
              <p>If you opt in to receive communications from us, we may send you educational content, insurance tips, and promotional materials in compliance with Canada's Anti-Spam Legislation (CASL). You may unsubscribe at any time by clicking the "unsubscribe" link in any email or by contacting us directly. We will not send you marketing emails without your explicit consent.</p>
              ...
              <p>We do not sell your personal information to third parties. We may share your information with Primerica Life Insurance Company of Canada as necessary to provide you with quotes and coverage, with your consent.</p>
              ...
              <h2 className="font-['Playfair_Display'] text-xl font-bold text-[#1a365d] mt-8">6. Your Rights Under PIPEDA</h2>
              <p>You have the right to access, correct, or request deletion of your personal information held by us. You may also withdraw your consent to the processing of your data for marketing purposes at any time. To exercise these rights, please contact us using the information below.</p>
